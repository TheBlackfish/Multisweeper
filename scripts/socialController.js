...
function populatePlayerListTable(playerXML) {
	...
	for (var i = 0; i < playerNodes.length; i++) {
		var tempStr = "<tr class='scoreRank" + parseInt(playerNodes[i].getAttribute("scoreRank")) + "'><td><img src='images/blank_icon.png'/></td><td>" + playerNodes[i].childNodes[0].nodeValue + "</td>";
